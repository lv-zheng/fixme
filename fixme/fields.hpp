#ifndef LVZHENG_FIXME_FIELDS_HPP
#define LVZHENG_FIXME_FIELDS_HPP
...
enum class field_type : unsigned {
	Account = 1,
	AdvId = 2,
	AdvRefID = 3,
	AdvSide = 4,
...
extern const std::unordered_map<unsigned, std::string> field_str;

} } // namespace lvzheng::fixme

#endif // LVZHENG_FIXME_FIELDS_HPP
